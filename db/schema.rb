...
ActiveRecord::Schema.define(version: 20180128071926) do
  ...
  create_table "relationships", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.datetime "created_at",        null: false
    t.datetime "updated_at",        null: false
    t.index ["rental_bicycle_id"], name: "index_relationships_on_rental_bicycle_id", using: :btree
    t.index ["user_id", "rental_bicycle_id"], name: "index_relationships_on_user_id_and_rental_bicycle_id", unique: true, using: :btree
